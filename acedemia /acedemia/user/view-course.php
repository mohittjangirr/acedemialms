...
<html lang="en">
<head>
    <title>Acedemia | View Uploaded Courses</title>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $sql = "SELECT DISTINCT tblclass.Class, tblsubject.Subject, tblcourse.CourseTitle, tblcourse.CreationDate, tblcourse.ID as courseid
                                            FROM tblcourse
